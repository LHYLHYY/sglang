...
## Asymmetric attention TP2 with DP8
...
members still participate in the existing dense FFN and MoE execution.
...
The compute member loads complete attention projections, including their
scales and offsets. This increases attention projection memory per compute
rank compared with symmetric TP2 head sharding.
...
For an initial eager smoke test, add these settings to your validated
...
ranks. Measure throughput and single-request latency separately.
